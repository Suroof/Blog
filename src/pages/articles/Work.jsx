  ...
  const workExperiences = [
    {
      ...
      excerpt:
        "1.接受业务培训，详细了解各个环节和开发模式，完善客户所要求的erp系统。2.熟练掌握公司提供的开发工具，结合Vue、MySQL以及Spring框架等先进技术，针对客户的具体需求，对功能模块进行精细设计，使用javascript和vue进行功能排版和对接，用Mysql进行数据筛选，对客户要求的功能模块进行布局和实现，保持代码规范性，成功完成多个功能模块的开发与优化，客户对系统的稳定性和功能性表示高度认可。3.学会了使用钩子函数，实现数据监听和响应功能。",
      image: "/软件.png",
